...
<div class="container-wrapper">
	<div class="container">
		...
		<!-- sf:form을 쓰면 html의 form태그와는 다르게 csrf를 따로 적지 않아도 보내준다 -->
		<sf:form action="${pageContext.request.contextPath }/admin/productInventory/addProduct?${_csrf.parameterName }=${_csrf.token }" method="post" modelAttribute="product" enctype="multipart/form-data">
