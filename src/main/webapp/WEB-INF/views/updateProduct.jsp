...
<div class="container-wrapper">
	<div class="container">
		...
		<sf:form action="${pageContext.request.contextPath }/admin/productInventory/updateProduct?${_csrf.parameterName }=${_csrf.token }" method="post" modelAttribute="product">

			<sf:hidden path="id"/> <!-- id값도 넘겨주기 위함 -->
